$(document).ready(function () {
    ...
    var dataTable = $("#grade-datatable").DataTable({
        language: {
            ...
            info: "Mostrando secciones _START_ al _END_ de _TOTAL_",
            lengthMenu: 'Mostrar <select class=\'form-select form-select-sm ms-1 me-1\'><option value="10">10</option><option value="20">20</option><option value="-1">Todos</option></select> secciones',
