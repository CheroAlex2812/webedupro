<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8">
        <title>EduWebPro | {{ $pageTitle }}</title>
        ...
        <!-- third party css end -->
        <link href="{{asset('css/preferences.css')}}" rel="stylesheet" type="text/css">
        <!-- App css -->
    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
            ...
            <div class="content-page">
                        ...
                        <ul class="list-unstyled topbar-menu float-end mb-0">
                            ...
                            <li class="dropdown notification-list topbar-dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    ...
                                    <img src="{{asset('images/flags/peru.png')}}" alt="user-image" class="me-0 me-sm-1" height="12"> 
                                    <span class="align-middle d-none d-sm-inline-block">Español</span>
                                </a>
                            ...
                            {{-- <li class="notification-list" style="margin-top:23px; margin-left:5px; margin-right:7px;">
                        ...
                        <div class="app-search dropdown d-none d-lg-block">
                            <form>
                                <div class="input-group">
                                    <input style="font-weight: bold;" type="text" disabled class="form-control" value="I.E Nº 15397 CHARÁN COPOSO">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                <script>document.write(new Date().getFullYear())</script> © Copyright - I.E. Nº 15397 Charán Coposo
                            </div>
                            <div class="col-md-6">
            ...
            <div class="rightbar-content h-100" data-simplebar="">
                ...
                <div class="p-3">
                    <div class="alert alert-warning" role="alert">
                        <strong>Personalice </strong> el esquema de colores general, el menú de la barra lateral, etc.
                    </div>
                    ...
                    <div class="d-grid mt-4">
                        <button class="btn btn-primary" id="resetBtn">Restablecer valores por defecto</button>
                    </div>
                </div> <!-- end padding-->
        ...
        <script src="https://kit.fontawesome.com/d99e255265.js" crossorigin="anonymous"></script>
