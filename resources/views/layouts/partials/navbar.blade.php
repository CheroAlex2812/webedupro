<div class="leftside-menu">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar="">
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item {{ Request::is('parents*') ? 'menuitem-active' : '' }}">
            ...
            <li class="side-nav-item {{ Request::is('teacher*') ? 'menuitem-active' : '' }}">
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#academico" aria-expanded="false" aria-controls="academico" class="side-nav-link">
                    ...
                    <ul class="side-nav-second-level">
                        <li class="{{ request()->routeIs('grade.*') ? 'active' : '' }}">
                            <a href="{{route('grade.index')}}">
                                <i class="fa-regular fa-chart-bar" style="margin-right: 10px"></i>
                                <span> Grados </span>
                            </a>
                        </li>
                        <li class="{{ request()->routeIs('section.*') ? 'active' : '' }}">
                            <a href="{{route('section.index')}}">
                                <i class="dripicons-view-thumb" style="margin-right: 10px"></i>
                                <span> Sección </span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="mdi mdi-book-open-outline" style="margin-right: 10px"></i>
                                <span> Cursos </span>
                            </a>
                        </li>
